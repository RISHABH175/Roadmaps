      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Roadmaps.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Roadmaps, accessible from
            <a
              href="https://rishabh175.github.io/Roadmaps/"
              rel="external nofollow noopener"
              target="_blank"
              style="color: white"
              >https://rishabh175.github.io/Roadmaps/</a
            >
          </p>
        </li>
        <li>
