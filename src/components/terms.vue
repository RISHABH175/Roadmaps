  ...
  <div id="terms">
    ...
    <div id="a">
      ...
      <p>
        ...
        of Roadmaps's Website, located at
        https://rishabh175.github.io/Roadmaps/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use 1Stopn'Go if you do not agree to take
    ...
    <div id="a">
      ...
      <p>
        We employ the use of cookies. By accessing 1Stopn'Go, you agreed to use
        cookies in agreement with the Roadmaps's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Roadmaps and/or its licensors own the
        intellectual property rights for all material on 1Stopn'Go. All
        intellectual property rights are reserved. You may access this from
        1Stopn'Go for your own personal use subjected to restrictions set in
    ...
    <div id="a">
      ...
      <p>
        ...
        Roadmaps does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Roadmaps,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Roadmaps shall not be liable
      ...
      <p>
        Roadmaps reserves the right to monitor all Comments and to remove any
    ...
    <div id="a">
      <p>
        You hereby grant Roadmaps a non-exclusive license to use, reproduce,
    ...
    <div id="a">
      ...
      <p>
        ...
        the hyperlink compensates the absence of Roadmaps; and (d) the link is
      ...
      <p>
        ...
        e-mail to Roadmaps. Please include your name, your organization name,
    ...
    <div id="a">
      ...
      <p>
        No use of Roadmaps's logo or other artwork will be allowed for linking
