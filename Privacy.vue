...
<div id="a">
    ...
    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
        ...
        help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank"
            style="color: white;">Privacy Policy Generator</a>.</p>
    </div>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Roadmaps.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Roadmaps, accessible from <a
                    href="https://rishabh175.github.io/Roadmaps/" rel="external nofollow noopener" target="_blank"
                    style="color: white;">https://rishabh175.github.io/Roadmaps/</a></p>
        </li>
        <li>
    ...
    <ul>
        ...
        <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash
            ...
            deleting local shared objects?&quot; available at <a
                ...
                style="color: white;">https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</a>
        </li>
    ...
    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
        ...
        browser. Learn more about cookies: <a href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank"
            style="color: white;">Cookies: What Do They Do?</a>.</p>
    ...
    <ul>
        <li>By email: rishabhcreations333@gmail.com</li>
    </ul>
    </body>
      </template>
